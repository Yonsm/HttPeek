...
#define _HOOK_FUNCTION(RET, LIB, FUN, ...)				_HOOK_FUNCTION_(inline, RET, LIB, FUN, ##__VA_ARGS__)
#define _HOOK_MESSAGE(RET, CLS, MSG, ...)				_HOOK_MESSAGE_(inline, RET, CLS, MSG, , ##__VA_ARGS__)
#define _HOOK_META(RET, CLS, MSG, ...)					_HOOK_MESSAGE_(inline, RET, CLS, MSG, Meta, ##__VA_ARGS__)

// 自动初始化 HOOK
#define HOOK_FUNCTION(RET, LIB, FUN, ...)				_HOOK_FUNCTION_(__attribute__((constructor)), RET, LIB, FUN, ##__VA_ARGS__)
#define HOOK_MESSAGE(RET, CLS, MSG, ...)				_HOOK_MESSAGE_(__attribute__((constructor)), RET, CLS, MSG, , ##__VA_ARGS__)
#define HOOK_META(RET, CLS, MSG, ...)					_HOOK_MESSAGE_(__attribute__((constructor)), RET, CLS, MSG, Meta, ##__VA_ARGS__)
